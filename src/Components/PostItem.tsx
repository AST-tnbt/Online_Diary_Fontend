...
export default function PostItem({title, date, postId, deletePost} : PostPropType) {
    ...
    <div className="w-[30%] bg-[#fff] m-auto mt-4 border-2 border-[#B5C18E] py-4 px-6 rounded-md hover:shadow-xl hover:cursor-pointer">
        ...
        <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-4 items-center">
                <div onClick={() => navigate(`/post/update/${postId}`)}>
                  <svg xmlns="http:/index/www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 hover:cursor-pointer">
